...
const ACTIVE_RIDES: ActiveRide[] = [
  ...
  },
  {
    ...
    pickup: "Osu, Accra",
    dropoff: "Airport Residential, Accra",
    paymentMethod: "Card •••• 4242",
    platformCommission: 5.32,
    driverPayout: 9.88,
    specialNote: "Please arrive 5 minutes early",
  },
  {
    ...
    pickup: "GRA, Port Harcourt",
    dropoff: "Trans Amadi, Port Harcourt",
    paymentMethod: "Card •••• 4242",
    platformCommission: 4.48,
    driverPayout: 8.32,
    specialNote: "Please arrive 5 minutes early",
  },
  {
    ...
    dropoff: "Tema Community 1, Accra",
    paymentMethod: "Card •••• 9999",
    platformCommission: 7.84,
    driverPayout: 14.56,
    specialNote: "Please arrive 5 minutes early",
  },
  {
...
const RIDE_HISTORY: RideRecord[] = [
  ...
  {
    id: "RIDE2850",
    passenger: "Daniel Opoku",
    vehicle: "Mazda 3 2018",
    plate: "GH-234-56",
    driver: "Emmanuel Banda",
    pickup: "Northmead, Lusaka",
    dropoff: "Cairo Road, Lusaka",
    date: "2024-11-19",
    time: "10:15",
    duration: "15 mins",
    fare: 8.9,
  ...
  {
    id: "RIDE2848",
    passenger: "Blessing Adeyemi",
    vehicle: "Hyundai Elantra 2017",
    plate: "IB-678-QR",
    driver: "Tunde Bakare",
    pickup: "Bodija, Ibadan",
  ...
  {
    id: "RIDE2847",
    passenger: "Peter Mwale",
    vehicle: "Nissan Altima 2018",
    plate: "ZM-789-45",
    driver: "Emmanuel Banda",
    pickup: "Asokwa, Kumasi",
    dropoff: "Adum, Kumasi",
    date: "2024-11-18",
    time: "15:10",
    duration: "28 mins",
  ...
  {
    id: "RIDE2846",
    passenger: "Ngozi Okafor",
    vehicle: "Kia Sportage 2022",
    plate: "EN-456-78",
    driver: "Chukwuemeka Nwosu",
    pickup: "GRA, Enugu",
  ...
  {
    id: "RIDE2844",
    passenger: "Aisha Kamara",
    vehicle: "Toyota RAV4 2021",
    plate: "SL-012-CD",
    driver: "Mohamed Sesay",
    pickup: "Lumley, Freetown",
    dropoff: "Hill Station, Freetown",
    date: "2024-11-17",
    time: "11:00",
    duration: "35 mins",
    fare: 33.0,
        ...
        <div className="flex items-start justify-between p-5 border-b border-gray-100">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              Complete information for Ride {ride.id}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-center justify-between bg-gray-50 rounded-xl p-4">
            <div>
              ...
              <span
                className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium mt-1 ${STATUS_STYLES[ride.status]}`}
              >
                {ride.statusLabel}
              </span>
            </div>
          ...
          <div className="border border-gray-100 rounded-xl p-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <p className="font-bold text-gray-900">{fmtFare(ride.fare)}</p>
              </div>
              <div>
          ...
          {ride.specialNote && (
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-amber-600">{ride.specialNote}</p>
              </div>
            </div>
          )}
        </div>
...
function ActiveRidesView() {
  ...
  const stats = {
    ...
    ongoing: ACTIVE_RIDES.filter((r) => r.status === "ongoing").length * 28,
  };
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 pt-5 pb-3">
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${STATUS_STYLES[ride.status]}`}
                >
                  {ride.statusLabel}
                </span>
              </div>
            ...
            <div className="px-5 pb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                <div className="bg-[#F1F9FB] rounded-xl p-3 flex items-center gap-3">
                  <InitialAvatar
                    initials={ride.passenger.initials}
                    color={ride.passenger.color}
                  />
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      Vehicle: {ride.passenger.vehicle}
                    </p>
                    <p className="text-xs text-gray-400">
                      Plate: {ride.passenger.plate}
                    </p>
                  </div>
                </div>
                <div className="bg-[#F1F9FB] rounded-xl p-3 flex items-center gap-3">
              ...
              {/* ETA */}
              <div className="text-center mb-4 py-2 bg-[#F1F9FB] rounded-xl">
              ...
              <div className="space-y-2">
                <button className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium bg-[#3894A3] hover:bg-[#2F7F8C] text-white transition-colors">
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl text-sm font-medium text-gray-700 border border-gray-200 hover:bg-gray-50 transition-colors"
                >
                  View Details
                </button>
...
function RideHistoryView() {
  ...
  const stats = {
    ...
    revenue: RIDE_HISTORY.filter((r) => r.status === "completed").reduce(
      (s, r) => s + r.fare,
      0,
    ),
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 p-4 border-b border-gray-100">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:border-transparent placeholder:text-gray-400"
            />
          </div>
              ...
              {paginated.length === 0 ? (
                ...
                paginated.map((r) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5">
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize ${HIST_STATUS_STYLES[r.status]}`}
                      >
                        {r.status}
                      </span>
                    </td>
              ...
              <div key={r.id} className="p-4">
                ...
                <div className="bg-gray-50 rounded-lg p-2 mb-2 text-xs">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-gray-600">{r.pickup}</span>
                  </div>
                  <div className="flex items-center gap-1.5 mt-1">
                    <span className="w-2 h-2 rounded-full bg-red-500" />
                    <span className="text-gray-600">{r.dropoff}</span>
                  </div>
                </div>
              ...
              .map((n, i) =>
                n === "…" ? (
                  ...
                  <button
                    ...
                    className={`w-8 h-8 rounded-lg text-sm font-medium transition-colors ${safePage === n ? "bg-[#3894A3] text-white" : "text-gray-600 hover:bg-gray-100"}`}
                  >
                    {n}
                  </button>
                ),
